...
{
    public class CreateKirimSPDCommandHandler : ICommandHandler<CreateKirimSPDCommand>
    {
        ...
        public CreateKirimSPDCommandHandler(IUnitOfWork<FinanceContext> uow,
        ...
        public async Task Handle(CreateKirimSPDCommand command, CancellationToken cancellationToken)
        {
            try
            {
